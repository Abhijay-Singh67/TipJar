...
const Card = (props) => {
    return (
        <div className='w-[90vw] mx-auto my-[30px]'>
            <div className={props.reverse?"flex-row-reverse rounded-3xl card flex justify-between py-10 px-25 bg-[#f3f1f1]":"rounded-3xl card flex justify-between py-10 px-25 bg-[#f3f1f1]"}>
