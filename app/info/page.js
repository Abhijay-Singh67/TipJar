                ...
                <div className="content flex flex-col items-center py-10 gap-10 w-[100%] h-[70%]">
                    ...
                    <form ref={form} onSubmit={(e) => { submitProfile(e) }} className='flex flex-col gap-7 text-lg w-[100%]'>
                        <div className="name flex gap-2">
                            <input required={true} name="first" type="text" placeholder="First Name" className='bg-white rounded-full py-5 px-5 flex-grow' />
                            <input required={true} name="last" type="text" placeholder="Last Name" className='bg-white rounded-full py-5 px-5 flex-grow' />
                        </div>
                        <textarea name="about" placeholder='About You' minLength={1} maxLength={350} required={true} className='bg-white rounded-4xl py-5 px-5 flex-grow h-52'></textarea>
                        <div className='flex flex-col gap-3 items-center justify-center text-sm'>
                            ...
                            <h1 className='text-sm italic text-gray-500 text-center'>Note: It is not compulsory to upload a QR but if you don't then you will be opting out of recieving payments.</h1>
                        ...
                        <button type='submit' className='cursor-pointer rounded-full bg-red-500 w-max self-center px-5 py-3 text-white'>Proceed</button>
                    </form>
                </div>
            </div>
        </div>
